                ...
                VStack {
                    ...
                    if let unwrappedUser = user {
                        if unwrappedUser.total >= 0 {
                            ...
                            case "Intermediate":
                                Text("If you made it to this level, congrats! Very few people make it this far by accident. By now, powerlifting/lifting is probably important to you, maybe even a part of who you are. However, this is also a big crossroads for many people, as progress may get slower without some big changes. If you're content with the way your current strength turns heads, that's great! If not, it might be helpful to get a coach to get you a custom program, or just try an existing one online.")
                                    .padding()
                                    .multilineTextAlignment(.center)
                            case "Advanced":
                                Text("Ok, you're strong. While genetics, bodyweight, and training style all make a difference in the experience and timeframe, only you know how hard you worked to get here. At this point, its too late to turn back. Don't you want to find out how strong you can get? Go for it! Get on that bulk, hire that coach, and squeeze out every last drop of progress you can. You'll thank youself in the future, when your kids start arguing about who's dad would win in a fight.")
                                    .padding()
                                    .multilineTextAlignment(.center)
                            case "Elite":
                            ...
                            Spacer()
                            NavigationLink(destination: SaveView2(user: unwrappedUser, navigationPath: $navigationPath)) {
                                Text("Next")
...
#Preview {
    ResultsView2(navigationPath: .constant(NavigationPath()))
